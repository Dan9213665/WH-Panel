...
"Темные процессы живут своей жизнью и ждут момента, чтобы уничтожить вас."
        ...
        public string SelectTheCredentialsByLoggedUser(AppSettings settings)
        {
            ...
            if (currentUser == "lgt01")
                apiPriority.AddRange(new[] { "6ADFFD01B1B04B10A4F8FD7BCA8631D8", "AEF3B8E8189A481786598CCCFD16A56A", "7D4B614B3FD645F584C8661B813B5E98", "B59C4AB83FBB4784A3EBA712AF023DE9" }); //""  6D3162B8E0F34660BCF256E7BBC3524C
            else if (currentUser == "rbtwh")
                apiPriority.AddRange(new[] { "B59C4AB83FBB4784A3EBA712AF023DE9", "AEF3B8E8189A481786598CCCFD16A56A", "7D4B614B3FD645F584C8661B813B5E98", "6ADFFD01B1B04B10A4F8FD7BCA8631D8" }); //""  6D3162B8E0F34660BCF256E7BBC3524C
            else if (currentUser == "rbtwh2")
                apiPriority.AddRange(new[] { "B59C4AB83FBB4784A3EBA712AF023DE9", "AEF3B8E8189A481786598CCCFD16A56A", "7D4B614B3FD645F584C8661B813B5E98", "6ADFFD01B1B04B10A4F8FD7BCA8631D8" }); //""  6D3162B8E0F34660BCF256E7BBC3524C
            else
                apiPriority.AddRange(new[] { "7D4B614B3FD645F584C8661B813B5E98", "6ADFFD01B1B04B10A4F8FD7BCA8631D8", "AEF3B8E8189A481786598CCCFD16A56A", "B59C4AB83FBB4784A3EBA712AF023DE9" }); //""  6D3162B8E0F34660BCF256E7BBC3524C
