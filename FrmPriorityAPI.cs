...
"Темные процессы живут своей жизнью и ждут момента, чтобы уничтожить вас."
        ...
        public string SelectTheCredentialsByLoggedUser(AppSettings settings)
        {
            ...
            if (currentUser == "lgt01")
                ...
                apiPriority.AddRange(new[] { "6ADFFD01B1B04B10A4F8FD7BCA8631D8","AEF3B8E8189A481786598CCCFD16A56A", "7D4B614B3FD645F584C8661B813B5E98", "6D3162B8E0F34660BCF256E7BBC3524C", "B59C4AB83FBB4784A3EBA712AF023DE9" }); 
